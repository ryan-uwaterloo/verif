...
//   //trace fifos
//   val dcache_fifo = Module(new TraceFifo(new BoomDCacheReq))
//   val icache_fifo = Module(new TraceFifo(new ICacheBundle))
...
//   outer.frontend.module.io.cpu <> icache_fifo
//   dcache_fifo <> lsu.io.fifo
