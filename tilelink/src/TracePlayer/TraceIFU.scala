...
//  */
// class TraceFrontend(val icacheParams: ICacheParams, staticIdForMetadataUseOnly: Int)(implicit p: Parameters) extends LazyModule
// {
...
//  */
// class TraceFrontendBundle(val outer: BoomFrontend) extends CoreBundle()(outer.p)
// {
//   val fifo = Flipped(new BoomFrontendIO())
// }
...
//   with HasBoomFrontendParameters
// {
//   val io = IO(new TraceFrontendBundle(outer))
...
//   icache.io.req.valid     := fifo.valid
//   icache.io.req.bits.addr := fifo.bits.addr //virtual tag, 

//   // --------------------------------------------------------
//   // **** ICache Access (F1) ****
//   //      Translate VPC
//   // --------------------------------------------------------
//   val s1_vpc       = RegNext(fifo.bits.addr)
//   val s1_valid     = RegNext(s0_valid, false.B)
//   val s1_is_replay = RegNext(s0_is_replay)

//   icache.io.s1_paddr := s1_vpc //what if we just ignore virtual addresses because we have entirely physicaly addresses :^)
//   icache.io.s1_kill  := false.B // something will kill this but idk what it is...
